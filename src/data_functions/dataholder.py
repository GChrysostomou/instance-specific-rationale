...
class BERT_HOLDER_interpolation():
    ...
    def __init__(self, path = str, b_size = 8 , #mask_list = list, 
        ...
        fixed4 = pd.read_csv("./extracted_rationales/sst/data/fixed4.csv").to_dict("records")#[1066:1260] #list of dic
        fixed3 = pd.read_csv("./extracted_rationales/sst/data/fixed3.csv").to_dict("records")#[1066:1160] # for testing by cass
        fixed2 = pd.read_csv("./extracted_rationales/sst/data/fixed2.csv").to_dict("records")
        fixed1 = pd.read_csv("./extracted_rationales/sst/data/fixed1.csv").to_dict("records")
