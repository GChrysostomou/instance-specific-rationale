...
from src.models.bert import bert#, bert_TL
...
# def test_predictive_performance_TL(test_data_loader, for_rationale = False, output_dims = 2, save_output_probs = True, variable = False):    
...
# def train_and_save_TL(train_data_loader, dev_data_loader, for_rationale = False, output_dims = 2, variable = False):
...
#     classifier.to(device)
#     model = args["model"]
#     classifier.load_state_dict(torch.load(model, map_location=device))  # by cass
