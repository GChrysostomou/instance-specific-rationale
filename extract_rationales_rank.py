...
log_dir = "experiment_logs/extract_rank_" + user_args["dataset"] + "_" +  date_time + "/"
config_dir = "experiment_config/extract_rank_" + user_args["dataset"] + "_" + date_time + "/"
...
evaluator.create_rationales_rank_(data)
