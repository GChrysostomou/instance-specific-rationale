...
import json 
from src.models.deterministic.bert_components import BertModelWrapper, BertModelWrapper_zeroout, BertModelWrapper_noise, BertModelWrapper_attention
...
# soft = zeroout
class BertClassifier_soft(nn.Module):
    def __init__(self, output_dim = 2, dropout=0.1, tasc = None):
